...
class SearchAdapter(var userList:ArrayList<Users>,var userListFilter:ArrayList<Users>,val listener:(String)->Unit) : RecyclerView.Adapter<SearchAdapter.ViewHolder>(),Filterable {
